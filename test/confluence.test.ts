import { TextIn, Credentials, TextOut, RichText, RichString, Cookies } from '../src/types';
...
describe('Confluence01 Testing the Input of Text and doc generation', () => {
    before(() => {
        //setup fixture
    ...
    describe('ConfluenceTextIn', () => {
        ...
        it('should return the Transcript from the external source', (done) => {
            ...
            textinConfluence01.getTranscript(id).then((transcript) => {
                ...
                fs.writeFileSync(outputPath01, JSON.stringify(transcript, null, 2), 'utf8');
                ...
                if (h1.kind === 'textelement') {
                    ...
                    if ((richText as RichString)) {
                        ...
                        expect(richString.text).equals('1. Project Introduction. Statement of Purpose');
                        done();
                    } else {
